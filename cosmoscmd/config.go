...
func NewConfig() *Config {
	return &Config{
		...
		bech32AddressPrefix: map[string]string{
			"account_addr":   sdk.Bech32PrefixAccAddr,
			"validator_addr": sdk.Bech32PrefixValAddr,
			"consensus_addr": sdk.Bech32PrefixConsAddr,
			"account_pub":    sdk.Bech32PrefixAccPub,
			"validator_pub":  sdk.Bech32PrefixValPub,
			"consensus_pub":  sdk.Bech32PrefixConsPub,
		},
